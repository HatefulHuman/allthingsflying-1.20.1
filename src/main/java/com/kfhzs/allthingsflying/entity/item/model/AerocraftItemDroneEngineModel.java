...
public class AerocraftItemDroneEngineModel<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Objects.requireNonNull(ResourceLocation.tryBuild(AllThingsFlying.MODID, "drone_engine")), "main");
	...
	public AerocraftItemDroneEngineModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition xf1 = qixuan.addOrReplaceChild("xf1", CubeListBuilder.create().texOffs(22, 64).addBox(-5.0F, -18.0F, 12.0F, 10.0F, 32.0F, 0.0F, new CubeDeformation(0.03F)), PartPose.offset(21.0F, 0.0F, -23.0F));
		...
		PartDefinition xf4 = qixuan.addOrReplaceChild("xf4", CubeListBuilder.create().texOffs(22, 64).addBox(-5.0F, -18.0F, -12.0F, 10.0F, 32.0F, 0.0F, new CubeDeformation(0.03F)), PartPose.offset(21.0F, 0.0F, 23.0F));
		...
		PartDefinition xf2 = qixuan.addOrReplaceChild("xf2", CubeListBuilder.create().texOffs(22, 64).mirror().addBox(-5.0F, -18.0F, 12.0F, 10.0F, 32.0F, 0.0F, new CubeDeformation(0.03F)).mirror(false), PartPose.offset(-21.0F, 0.0F, -23.0F));
		...
		PartDefinition xf3 = qixuan.addOrReplaceChild("xf3", CubeListBuilder.create().texOffs(22, 64).mirror().addBox(-5.0F, -18.0F, -12.0F, 10.0F, 32.0F, 0.0F, new CubeDeformation(0.03F)).mirror(false), PartPose.offset(-21.0F, 0.0F, 23.0F));
