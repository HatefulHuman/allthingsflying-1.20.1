package com.kfhzs.allthingsflying.entity.aerocraft.carpet;
...
@OnlyIn(Dist.CLIENT)
public class FlyingCarpetEntityRender extends GeoEntityRenderer<FlyingCarpetEntity> {
    private final AerocraftBlockItemAeroEngineModel<FlyingCarpetEntity> aeroEngineModel;
    private final AerocraftItemThermalEngineModel<FlyingCarpetEntity> thermalEngineModel;
    private final AerocraftItemMagicEngineModel<FlyingCarpetEntity> magicEngineModel;
    private final AerocraftItemDroneEngineModel<FlyingCarpetEntity> droneEngineModel;
    ...
    public FlyingCarpetEntityRender(EntityRendererProvider.Context context) {
        super(context, new DefaultedEntityGeoModel<>(ResourceLocation.tryBuild(AllThingsFlying.MODID, "flying_carpet")));
    ...
    @Override
    public void render(FlyingCarpetEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    private void renderAeroEngineModelEffect(FlyingCarpetEntity entity, float partialTicks, PoseStack poseStack,
    ...
    private void renderThermalEngineModelEffect(FlyingCarpetEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
    ...
    private void renderMagicEngineEffect(FlyingCarpetEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
    ...
    private void renderDroneEngineEffect(FlyingCarpetEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
    ...
    private void renderStreamerEngineEffect(FlyingCarpetEntity entity, float partialTicks, PoseStack poseStack,
                                            MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
    ...
    private float calculateAlphaSmooth(FlyingCarpetEntity animatable) {
    ...
    private int getCurrentFrameIndex(FlyingCarpetEntity animatable, float partialTick, int totalFrames) {
