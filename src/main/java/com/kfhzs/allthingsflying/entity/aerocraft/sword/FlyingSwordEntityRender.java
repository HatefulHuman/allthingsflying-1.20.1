...
public class FlyingSwordEntityRender extends GeoEntityRenderer<FlyingSwordEntity> {
    ...
    private void renderAeroEngineModelEffect(FlyingSwordEntity entity, float partialTicks, PoseStack poseStack,
    ...
    private void renderThermalEngineModelEffect(FlyingSwordEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();

        poseStack.mulPose(Axis.YP.rotationDegrees(180));

        poseStack.translate(0.0F,-0.1F,1.2F);
    ...
    private void renderMagicEngineEffect(FlyingSwordEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();

        poseStack.mulPose(Axis.YP.rotationDegrees(180));

        poseStack.translate(0.0F, -1.2F, 2.2F);
    ...
    private void renderDroneEngineEffect(FlyingSwordEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
