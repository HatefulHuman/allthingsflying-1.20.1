...
public class DroneEntityRender extends GeoEntityRenderer<DroneEntity> {
    ...
    @Override
    public void render(DroneEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    private void renderAeroEngineModelEffect(DroneEntity entity, float partialTicks, PoseStack poseStack,
        ...
        poseStack.scale(1.0F, 0.175F, 1.0F);
    ...
    private void renderThermalEngineModelEffect(DroneEntity entity, float partialTicks, PoseStack poseStack,
                                                MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
        ...
        poseStack.translate(1.2F, 0.8F, -0.5F);
        ...
        poseStack.translate(-2.4F, 0.0F, 0.0F);
        ...
        poseStack.translate(0.0F, -2.8F, 0.0F);
    ...
    private void renderMagicEngineEffect(DroneEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
    ...
    private void renderDroneEngineEffect(DroneEntity entity, float partialTicks, PoseStack poseStack,
                                         MultiBufferSource buffer, int packedLight, float lerpYRot, float lerpXRot) {
        poseStack.pushPose();
    ...
    private int getCurrentFrameIndex(DroneEntity animatable, float partialTick, int totalFrames) {
