...
public class RocketEntity extends AerocrafEntity {
    ...
    public RocketEntity(Level level, double p_38294_, double p_38295_, double p_38296_, ItemStack stack) {
        this(EntityRegister.ROCKET_PC1.get(), level);
