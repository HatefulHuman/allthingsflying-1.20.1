...
public class FlyingSwordEntity extends AerocrafEntity {
    ...
    public FlyingSwordEntity(Level level, double p_38294_, double p_38295_, double p_38296_, ItemStack stack) {
        this(EntityRegister.FLYING_SWORD.get(), level);
    ...
    public void tick() {
        ...
        if (EngineHelper.getEngineItem(this.getItemStack()).is(ItemsRegister.THERMAL_ENGINE.get())) {
            if (this.playerSpeed > 0.2 && !this.isInWater()) {
                spawnThermalEngineParticles(this,0.25,2.0,0.2);
            } else {
                spawnThermalEngineParticles(this,0.15,2.0,0.15);
            }
        }else if (EngineHelper.getEngineItem(this.getItemStack()).is(ItemsRegister.CLOUD_ENGINE.get())) {
            if (this.playerSpeed > 0.2 && !this.isInWater()) {
                spawnCloudEngineParticles(this, 0.15,2.0,0.2);
            }
            ...
            if (this.playerSpeed > 0.2 && !this.isInWater()) {
                spawnWhiteLightParticles(this, 1.0,2.0,0.2);
            }
        }
